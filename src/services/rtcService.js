...
//       userMessageCallback(message.item.content);
//     } else if (message.item.role === 'assistant') {
//       assistantMessageCallback(message.item.content);
//     }
//   }
...
//     if (message.response.output && message.response.output[0]?.content) {
//       assistantMessageCallback(message.response.output[0].content);
//     }
//   }
}
